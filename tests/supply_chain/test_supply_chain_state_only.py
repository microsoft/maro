...
class MyTestCase(unittest.TestCase):
    ...
    def test_distribution_state_only_small_vlt(self) -> None:
        ...
        self.assertEqual([0, 0, 1, 0],  list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
        ...
        env.step(None)
        self.assertEqual([0, 1, 2, 0], list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
        self.assertEqual(1 * (1+2), distribution_unit.transportation_cost[SKU3_ID])

        env.step(None)
        self.assertEqual([1, 2, 0, 0], list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
        ...
        env.step(None)
        self.assertEqual([2, 0, 0, 3], list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
        ...
        env.step(None)
        self.assertEqual([0, 0, 3, 0], list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
        ...
        self.assertEqual([0, 3, 0, 0], list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
        ...
        self.assertEqual([3, 0, 1, 0], list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
        ...
        self.assertEqual([1, 0, 0, 0], list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
    ...
    def test_distribution_state_only_bigger_vlt(self) -> None:
        ...
        self.assertEqual(0, len(warehouse_1_distribution_unit._order_queues["train"]))
        self.assertEqual([0, 0, 0, 0], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))
        ...
        self.assertEqual([0, 0, 0, 1], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))

        # After env.step runs, where tick is 3. order_1 will arrive at tick=5. order_2 will arrive at tick=6.
        env.step(None)

        self.assertEqual([0, 0, 1, 2], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))
        ...
        env.step(None)
        self.assertEqual([0, 1, 2, 0], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))
        ...
        # order_2 will arrive at tick=6.order_3 is expected to arrive at tick=8 under normal circumstances.
        env.step(None)
        self.assertEqual([1, 2, 0, 0], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))
        ...
        env.step(None)
        self.assertEqual([2, 0, 0, 0], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))
        ...
        env.step(None)
        self.assertEqual([0, 0, 0, 3], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))

        # After env.step runs, where tick is 9. order_3 will arrive at tick = 11.
        # order_4 is expected to arrive at tick=12 under normal circumstances.
        env.step(None)
        self.assertEqual([0, 0, 3, 4], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))

        # After env.step runs, where tick is 10. order_3 will arrive at tick = 11.
        # order_4 is expected to arrive at tick=12 under normal circumstances.
        env.step(None)
        self.assertEqual([0, 3, 4, 0], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))

        # After env.step runs, where tick is 11. order_3 arrives after env.step.
        # order_4 is expected to arrive at tick=12 under normal circumstances.
        env.step(None)
        self.assertEqual([3, 4, 0, 0], list(env.metrics["products"][retailer_1.products[SKU2_ID].id]["pending_order_daily"]))
    ...
    def test_distribution_state_only(self) -> None:
        ...
        # vlt is greater than len(pending_order_len), which will cause the pending order to increase
        self.assertEqual([0, 0, 20, 0], list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
        ...
        self.assertEqual([20, 25, 0, 0],  list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))

        env.step(None)
        self.assertEqual([25, 0, 0, 30],  list(env.metrics["products"][warehouse_1.products[SKU3_ID].id]["pending_order_daily"]))
