...
class TestFrame(unittest.TestCase):
    ...
    def test_slice_quering(self):
        for backend_name in backends_to_test:
            ...
            frame = build_frame(True, total_snapshot=2, backend_name=backend_name)
            ...
            if backend_name == "dynamic":
                ...
                self.assertEqual(
                    0, static_node_a2_states.astype("i")[0], msg="states before taking snapshot should be 0"
                )
            ...
            self.assertListEqual(
                ...
                [100 * i + 1 for i in range(len(frame.static_nodes))],
            ...
            if backend_name == "dynamic":
                ...
                self.assertListEqual(
                    [0] * len(frame.static_nodes), list(states[0].astype("i")), msg="over-wrote tick should return 0"
                )
    ...
    def test_snapshot_length(self):
        ...
        for backend_name in backends_to_test:
            frm = build_frame(True, total_snapshot=10, backend_name=backend_name)
