...
class TestGrassCopy(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.deployment_template_path = os.path.normpath(
            os.path.join(cls.dir_path, "../templates/test-grass-azure-create.yml"))
        cls.deployment_path = os.path.expanduser(f"{GlobalPaths.MARO_TEST}/{cls.test_id}/test-grass-azure-create.yml")
