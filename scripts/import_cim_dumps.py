        ...
        for instance_index in range(instance_number):
            ...
            for field_index in range(len(field_name_list)):
                ...
                if field_length == 1:
                    ...
                    field_dict[field_name] = list([v.item() for v in instance_list[tick][instance_index][field_name]])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", required=True, help="Experiment name show in database")
    parser.add_argument("--scenario", required=True, help="Scenario name of import experiment")
    parser.add_argument("--topology", required=True, help="Topology of target scenario")
    parser.add_argument("--durations", required=True, type=int, help="Durations of each episode")
    parser.add_argument("--episodes", required=True, type=int, help="Total episode of this experiment")

    parser.add_argument("--dir", required=True, help="Root folder of dump files")
    parser.add_argument("--ssdir", help="Folder that contains snapshots data that with epoch_x sub-folders")

    parser.add_argument("--host", default="127.0.0.1", help="Host of questdb server")
