...
class EcrDataDumpUtil:
    """Utilities to dump ecr data from data collection, it will generate following files in specified folder.
    ports.csv, vessels.csv, stops.csv, routes.csv, order_proportion.csv, global_order_proportion.txt, misc.yml
    
    Args:
        data_collection (EcrDataCollection): data collection to dump
    """

    def __init__(self, data_collection: EcrDataCollection):
        self._data_collection = data_collection

    def dump(self, output_folder: str):
        """Dump ecr data into specified folder
...
def dump_from_config(config_file: str, output_folder: str, max_tick: int):
    """Dump ecr data from config, this will call data generator to generate data , and dump it
