...
from .entities import Order, Stop, PortSetting, NoisedItem, VesselSetting, EcrDataCollection, OrderGenerateMode
...
class EcrDataContainer:
    """Data container for ecr scenario, used to provide interfaces for business engine, and hide the details about data source, 
    ...
    Args:
        data_collection (EcrDataCollection): data collection from data source
