...
from .entities import EcrDataCollection, PortSetting, NoisedItem
...
class PortBufferTickWrapper:
    ...
    Args:
        data (EcrDataCollection): ecr data collection
        attribute_func (callable): function to get attribute, used to switch between empty and full

    """
    def __init__(self, data: EcrDataCollection, attribute_func: callable):
