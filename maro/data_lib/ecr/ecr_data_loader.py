...
from .entities import EcrDataCollection, OrderGenerateMode, NoisedItem, PortSetting, VesselSetting, Stop, RoutePoint


class EcrDumpDataLoader:
    """Utility to load data from dump folder"""
    def load(self, dumps_folder: str) -> EcrDataCollection:
        ...
        Returns:
            EcrDataCollection: data collection for data container
        """
        # load from files
        ...
        data_collection = EcrDataCollection(
...
def load_from_folder(source_folder: str) -> EcrDataCollection:
    """Load data from dump folder
    ...
    Returns:
        EcrDataCollection: data collection for ecr data container
    """
    loader = EcrDumpDataLoader()
