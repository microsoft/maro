...
class BinaryMeta:
    ...
    def from_bytes(self, meta_bytes: Union[bytes, bytearray, memoryview]):
        ...
        self._adjust_attrs = {i: a.adjust_ratio for i, a, in enumerate(self._attrs) if a.adjust_ratio is not None}
    ...
    def _validate(self, conf: dict):
        ...
        for evt_type_name, event_settings in events_def.items():
            ...
            self._events.append(Event(display_name, evt_type_name, value_in_csv))
