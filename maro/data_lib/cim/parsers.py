...
class VesselsParser:
    ...
    """
    @staticmethod
    def parse(conf: dict) -> (Dict[str, int], List[VesselSetting]):
...
class GlobalOrderProportion:
    ...
    """
    @staticmethod
    def parse(conf: dict, total_container: int, max_tick: int, start_tick: int = 0) -> np.ndarray:
...
class RoutesParser:
    ...
    """
    @staticmethod
    def parse(conf: dict) -> (Dict[str, int], List[List[RoutePoint]]):
...
class PortsParser:
    ...
    """
    @staticmethod
    def parse(conf: dict, total_container: int) -> (Dict[str, int], List[SyntheticPortSetting]):
