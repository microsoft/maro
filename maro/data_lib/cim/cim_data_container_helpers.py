...
def data_from_generator(
    config_path: str, max_tick: int, start_tick: int = 0, topology_seed: int = None
    ...
    Returns:
        CimSyntheticDataContainer: Data container used to provide cim data related interfaces.
    """
    data_collection = gen_cim_data(config_path, start_tick=start_tick, max_tick=max_tick, topology_seed=topology_seed)
