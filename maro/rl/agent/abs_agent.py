...
class AbsAgent(ABC):
    ...
    Args:
        ...
        experience_pool (AbsStore): A data store that stores experiences generated by the experience shaper. This is
            only necessary for some algorithms. Defaults to None.
    """
