...
from maro.utils.exception.rl_toolkit_exception import WrongAgentModeError
...
class AbsAgent(ABC):
    ...
    Args:
        ...
        mode (AgentMode): An ``AgentMode`` enum member that indicates the role of the agent in the current process.
    ...
    """
    def __init__(self, name: str, mode: AgentMode, algorithm: AbsAlgorithm, experience_pool: AbsStore = None):
        self._name = name
        self._mode = mode
