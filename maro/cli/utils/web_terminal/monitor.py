...
"""
    ...
    job_str = f"""<details>
<summary> <span class="dot" style="background-color: {color}; border-radius: 50%; height: 1rem; width: 1rem; display: inline-block;"></span>  {data['name']}    Mode: {data['mode']} </summary>
{component_html}
</details>"""
