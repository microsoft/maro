...
def load_parser_local(prev_parser: ArgumentParser, global_parser: ArgumentParser) -> None:
    ...
    # maro local run
    from maro.cli.local.command_functions import run
    ...
    # maro local init
    from maro.cli.local.command_functions import init
    parser = subparsers.add_parser(
        "init",
    ...
    # maro local exit
    from maro.cli.local.command_functions import exit
    parser = subparsers.add_parser(
        "exit",
    ...
    # maro local job add
    from maro.cli.local.command_functions import add_job
    ...
    # maro local job rm
    from maro.cli.local.command_functions import remove_jobs
    ...
    from maro.cli.local.command_functions import describe_job
    job_stop_parser = job_subparsers.add_parser(
        "describe",
    ...
    # from maro.cli.local.command_functions import delete_job
    ...
    # maro local job ls
    from maro.cli.local.command_functions import list_jobs
    ...
    # maro local job logs
    from maro.cli.local.command_functions import get_job_logs
