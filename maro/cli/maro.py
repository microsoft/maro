...
def load_parser_project(prev_parser: ArgumentParser, global_parser: ArgumentParser):
    ...
    from maro.cli.project_generator.project_generator import run_project, new_project

    # maro project run
    run_cmd_parser = sub_parsers.add_parser(
        "run",
        help="Run a project that generated by 'maro project new' command.",
        parents=[global_parser]
    )
    ...
    run_cmd_parser.set_defaults(func=run_project)
