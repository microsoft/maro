...
class StackChartCtrl extends MetricsPanelCtrl {
  ...
  onInitEditMode() {
    this.addEditorTab('Options', 'public/plugins/grafana-stackchart-panel/editor.html', 2);
...
export { StackChartCtrl, StackChartCtrl as MetricsPanelCtrl };
