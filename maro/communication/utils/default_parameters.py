...
proxy = convert_dottable(
    {
        ...
        "peer_discovery": {"initial_retry_interval": 0.1, "max_retries": 10},
        "redis": {"host": "localhost", "port": 6379, "initial_retry_interval": 0.1, "max_retries": 10},
        "peer_rejoin": {
            "enable": False,
...
driver = convert_dottable({"zmq": {"protocol": "tcp", "send_timeout": -1, "receive_timeout": -1}})
