...
if __name__ == "__main__":
    ...
    algo_inst_creator = scenario.algorithm_instance_creator
    ...
    training_manager = TrainingManager(policy_creator, algo_inst_creator, agent2policy, logger=logger)
    ...
    for ep in range(1, NUM_EPISODES + 1):
        ...
        while not end_of_episode:
            ...
            if CHECKPOINT_PATH and ep % CHECKPOINT_INTERVAL == 0:
                ...
                logger.info(f"All training states saved under {pth}")
            segment += 1
