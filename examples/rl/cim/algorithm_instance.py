...
if algorithm == "ac":
    ...
    algorithm_instance_creator = {f"ac_{i}": partial(get_ac, state_dim) for i in range(4)}
elif algorithm == "dqn":
    ...
    algorithm_instance_creator = {f"dqn_{i}": get_dqn for i in range(4)}
    ...
    algorithm_instance_creator = {f"discrete_maddpg_{i}": partial(get_maddpg, state_dim, [1]) for i in range(4)}
else:
