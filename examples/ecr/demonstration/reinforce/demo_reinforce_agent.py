...
class DemoReinforceAgent(Agent):
    def __init__(self,
        ...
        super(DemoReinforceAgent, self).__init__(agent_name=agent_name,
                                        topology=topology,
    ...
    def train(self, current_ep: int):
        ...
        for i in pbar:
            ...
            self_sampled_dict = self._experience_pool.get( \
                category_idx_batches=[('state', self_sampled_idxs), ('action', self_sampled_idxs), ('reward', self_sampled_idxs)])
            ...
            demo_sampled_dict = self._demo_experience_pool.get( \
                category_idx_batches=[('state', demo_sampled_idxs), ('action', demo_sampled_idxs), ('reward', demo_sampled_idxs)])
            ...
            self._algorithm.learn(self_state_batch, self_action_batch, self_reward_batch, \
                                  demo_state_batch, demo_action_batch, demo_reward_batch, \
