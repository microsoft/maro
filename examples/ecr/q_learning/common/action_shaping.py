...
class DiscreteActionShaping():
    ...
    def __call__(self, scope: ActionScope, action_index: int, port_empty: float, vessel_remaining_space: float, early_discharge: int, reward_type: str) -> int:
        '''
        Args:
        ...
        if action_index > self._zero_action_index:
            ...
            if plan_action > 0 and reward_type == 'gf':
