    ...
    def step(self):
        ...
        while not self.done:
            ...
            if self.global_step_number % 1000 == 0:
                print('action: ', self.action, eval_ep, self.reward, self.done, self.global_step_number, self.episode_number)
        # print('total_experience_num: ', self.total_episode_score_so_far)
