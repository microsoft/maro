...
class CitibikeStateShaping:
    def __init__(
        ...
        if action_shaping_cls is not None:
            self.action_scaler = action_shaping_cls.action_scaler
        else:
    ...
    def extract_channels(self, cur_frame_index: int):
        ...
        # distance_mat = self.distance_scaler * self._env.snapshot_list['matrices'][
        #     0 : : 'distance_adj'
        # ].reshape(self._station_cnt, self._station_cnt, 1)
