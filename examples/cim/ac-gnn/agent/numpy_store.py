...
def get_experience_pool(num_static_nodes, num_dynamic_nodes, exp_per_ep, p_dim, v_dim):
    ...
    return {agent_id: NumpyStore(value_dict, size) for agent_id, size in exp_per_ep.items()}
