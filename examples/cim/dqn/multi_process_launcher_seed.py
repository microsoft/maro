...
if __name__ == "__main__":
    ...
    learner_path = f"{os.path.split(os.path.realpath(__file__))[0]}/dist_learner_seed.py &"
    actor_path = f"{os.path.split(os.path.realpath(__file__))[0]}/dist_actor_seed.py &"
