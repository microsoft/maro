...
from examples.cim.common import (
    PORT_ATTRIBUTES, VESSEL_ATTRIBUTES, ACTION_SPACE, LOOK_BACK, REWARD_TIME_WINDOW, TIME_DECAY,
    FULFILLMENT_FACTOR, SHORTAGE_FACTOR
)
